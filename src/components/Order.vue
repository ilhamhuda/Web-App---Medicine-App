...
<v-card style="width:1250px;height:500px">
    <div class="invoice-box" style="width:1250px;height:500x">
      ...
      <td colspan="4">
        <table>
          <tr>
            ...
            <td>
              Invoice #:<br> Created: {{tanggalProduk}}<br>
            </td>
          </tr>
        </table>
      </td>
...
<v-data-table
  ...
  <v-btn class="ma-2" tile outlined @click="cetak()" color="success">
    ...
    <v-btn class="ma-2" tile outlined @click="dialog = false" color="error">
